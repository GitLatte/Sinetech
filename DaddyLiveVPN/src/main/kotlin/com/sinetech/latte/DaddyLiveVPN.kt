...
class DaddyLiveVPN : MainAPI() {
    private val mainUrls = listOf(
        "https://raw.githubusercontent.com/GitLatte/temporarylists/refs/heads/main/dl/daddylive-vpn.m3u",
    )
    ...
    override var name                 = "DaddyLive Spor (🛡️VPN)"
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        mainUrls.forEach { url ->
            try {
                ...
                Log.e("DaddyLiveVPN", "Error loading M3U from $url: ${e.message}")
            }
        }
